...
<body>
                ...
                <div>
                    ...
                    <div class="dropdown d-inline-block ms-1">
                        ...
                        <div class="dropdown-menu dropdown-menu-end fs-sm smini-hide border-0"
                            ...
                            <a class="dropdown-item d-flex align-items-center justify-content-between fw-medium"
                                data-toggle="theme" data-theme="assets/css/themes/amethyst.min-5.9.css"
                                href="#">
                                <span>Amethyst</span>
                                <i class="fa fa-circle text-amethyst"></i>
                            </a>
                            <a class="dropdown-item d-flex align-items-center justify-content-between fw-medium"
                                data-toggle="theme" data-theme="assets/css/themes/city.min-5.9.css" href="#">
                                <span>City</span>
                                <i class="fa fa-circle text-city"></i>
                            </a>
                            <a class="dropdown-item d-flex align-items-center justify-content-between fw-medium"
                                data-toggle="theme" data-theme="assets/css/themes/flat.min-5.9.css" href="#">
                                <span>Flat</span>
                                <i class="fa fa-circle text-flat"></i>
                            </a>
                            <a class="dropdown-item d-flex align-items-center justify-content-between fw-medium"
                                data-toggle="theme" data-theme="assets/css/themes/modern.min-5.9.css" href="#">
                                <span>Modern</span>
                                <i class="fa fa-circle text-modern"></i>
                            </a>
                            <a class="dropdown-item d-flex align-items-center justify-content-between fw-medium"
                                data-toggle="theme" data-theme="assets/css/themes/smooth.min-5.9.css" href="#">
                                <span>Smooth</span>
                            ...
                            <table class="table table-hover table-vcenter">
                                ...
                                <tbody class="fs-sm">
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell fw-semibold text-muted text-end">17 min ago
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell fw-semibold text-muted text-end">24 min ago
                                        </td>
                                        <td class="d-none d-sm-table-cell text-end">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell fw-semibold text-muted text-end">16 min ago
                                        </td>
                                        <td class="d-none d-sm-table-cell text-end">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell fw-semibold text-muted text-end">23 min ago
                                        </td>
                                        <td class="d-none d-sm-table-cell text-end">
                                            <strong>$73,68</strong>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell fw-semibold text-muted text-end">9 min ago
                                        </td>
                                        <td class="d-none d-sm-table-cell text-end">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell fw-semibold text-muted text-end">28 min ago
                                        </td>
                                        <td class="d-none d-sm-table-cell text-end">
    ...
    <script src="{{ asset('admins/js/oneui.app.min-5.9.js')}}"></script>
    <script src="{{ asset('admins/js/chart.umd.js')}}"></script>
    <script src="{{ asset('admins/js/be_pages_dashboard.min.js')}}"></script>
</body>
